...
{% asset_img "image_tensor_visualization.png" "Numpy 张量与图像通道可视化" %}
...
{% asset_img "color_space_comparison.png" "RGB 颜色立方体 vs HSV 圆柱体模型对比图" %}
...
{% asset_img "bgr_rgb_avatar_effect.png" "通道错位对比图（BGR vs RGB）" %}
...
{% asset_img "demo_linear.png" "线性变换效果展示" %}
...
{% asset_img "demo_gamma.png" "Gamma 校正效果展示" %}
...
{% asset_img "demo_affine.png" "仿射变换效果展示" %}
...
{% asset_img "demo_roi.png" "ROI 提取效果展示" %}

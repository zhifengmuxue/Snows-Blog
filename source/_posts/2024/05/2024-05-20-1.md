...
description:
  - >-
    在这篇文章中，我们通过一个简单的Spring
    Boot应用程序示例，展示了如何集成MyBatis和SQLite数据库，并详细介绍了每一层的功能和实现方法。
abbrlink: aa52dc7b
...
<img src="{% asset_path 'image-20240520223850580.png' %}" alt="image-20240520223850580" style="zoom:67%;" />

这是一个简单的层次结构图：

{% asset_img "未命名绘图.drawio.png" "未命名绘图.drawio" %}
